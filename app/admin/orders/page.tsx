...
function AdminOrdersContent() {
  const { orders, requests, users, artistProfiles, chatRooms } = useGiftraStore()
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Monitor and manage all orders on the platform</p>
      </div>
          ...
          {sortedOrders.length === 0 ? (
            ...
            <div className="divide-y divide-border">
              {sortedOrders.map((order) => {
                ...
                const artist = artistProfiles.find(a => a.id === order.artistId)
