...
import { Gift, Eye, EyeOff, ArrowLeft, Mail, Lock, User } from "lucide-react";
        ...
        <div className="relative flex h-full flex-col items-center justify-center p-12 text-white">
          <div className="max-w-md text-center">
            ...
            <p className="mt-4 text-lg text-white/80">
              ...
              moment. Let AI help you make every gift count.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-4">
            ...
            <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <div>
                <p className="font-medium">Never Forget</p>
                <p className="text-sm text-white/70">
            ...
            <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
              ...
              <div>
                <p className="font-medium">Curated Marketplace</p>
                <p className="text-sm text-white/70">
                  Unique gifts from trusted vendors
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Start your journey to thoughtful gifting
            </p>
          </motion.div>
