...
import { Gift, Eye, EyeOff, ArrowLeft, Mail, Lock } from "lucide-react";
        ...
        <div className="relative flex h-full flex-col items-center justify-center p-12 text-white">
          <div className="max-w-md text-center">
            ...
            <p className="mt-4 text-lg text-white/80">
              Let AI help you find the perfect gift for every person and
              occasion. Your relationships deserve thoughtful gestures.
            </p>
          </div>

          {/* Decorative Elements */}
          <div className="absolute bottom-12 left-12 flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
            <div className="flex size-12 items-center justify-center rounded-xl bg-white/20">
              <Gift className="size-6" />
            </div>
            <div>
              <p className="font-medium">50,000+</p>
              <p className="text-sm text-white/70">Gifts delivered with love</p>
            </div>
          </div>
        </div>
      </div>
