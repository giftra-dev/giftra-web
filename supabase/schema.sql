...
CREATE TABLE public.requests (
  ...
  artist_decision TEXT NOT NULL DEFAULT 'pending' CHECK (artist_decision IN ('pending', 'accepted', 'rejected')),
  artist_decision_note TEXT,
  artist_decision_at TIMESTAMPTZ,
